  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Link to="/plant-growth-records" className="p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md">
        ...
        <Link to="/seed-germination" className="p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md">
        ...
        <Link to="/composting-soil-mix" className="p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md">
